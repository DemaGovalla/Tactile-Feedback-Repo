...
Description: The file uses the data from features_train_test.csv to plot the different 
            features (Force, X-axis, Y-axis, Z-ais) for data representation. It then passes the 
            feature data through two smoothing filters and plots the result. Next, we save the filtered 
            data into combined_sensorData.csv. This CSV file trains, tests, and analyzes
            the machine learning models - RFMN and TSC-LS. 
"""
