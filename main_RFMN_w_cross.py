...
def plot_accuracy_bar_graph(values_array, theta_labels, plot_title, save_filename):
...
def main():
    ...
    '''
    plot_accuracy_bar_graph(mae_values_array_def, theta_values, "mae_deformation_plot", "mae_deformation_plot")
    plot_accuracy_bar_graph(mse_values_array_def, theta_values, "mse_deformation_plot", "mse_deformation_plot")
    plot_accuracy_bar_graph(rmse_values_array_def, theta_values, "rmse_deformation_plot", "rmse_deformation_plot")
    plot_accuracy_bar_graph(r2_values_array_def, theta_values, "r2_deformation_plot", "r2_deformation_plot")
    
    plot_accuracy_bar_graph(accuracy_values_array_def, theta_values, "accuracy_deformation_plot", "accuracy_deformation_plot")
    plot_accuracy_bar_graph(precision_values_array_def, theta_values, "precision_deformation_plot", "precision_deformation_plot")
    plot_accuracy_bar_graph(recall_values_array_def, theta_values, "recall_deformation_plot", "recall_deformation_plot")
    plot_accuracy_bar_graph(f1_values_array_def, theta_values, "f1_deformation_plot", "f1_deformation_plot")
    
    '''
    Plot for texture
    '''
    plot_accuracy_bar_graph(mae_values_array_tex, theta_values, "mae_texture_plot", "mae_texture_plot")
    plot_accuracy_bar_graph(mse_values_array_tex, theta_values, "mse_texture_plot", "mse_texture_plot")
    plot_accuracy_bar_graph(rmse_values_array_tex, theta_values, "rmse_texture_plot", "rmse_texture_plot")
    plot_accuracy_bar_graph(r2_values_array_tex, theta_values, "r2_texture_plot", "r2_texture_plot")
    
    plot_accuracy_bar_graph(accuracy_values_array_tex, theta_values, "accuracy_texture_plot", "accuracy_texture_plot")
    plot_accuracy_bar_graph(precision_values_array_tex, theta_values, "precision_texture_plot", "precision_texture_plot")
    plot_accuracy_bar_graph(recall_values_array_tex, theta_values, "recall_texture_plot", "recall_texture_plot")
    plot_accuracy_bar_graph(f1_values_array_tex, theta_values, "f1_texture_plot", "f1_texture_plot")
